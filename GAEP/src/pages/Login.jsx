        ...
        <div className={styles['login-container']}>
            <div className={styles['login-left']}>
                <div className={styles['login-form-container']}>
                    <img src={imglog} alt="Logo" className={styles['brand-logo']} />
                    <h2 className={styles['login-heading']}>Iniciar Sesión</h2>
                    ...
                    <form onSubmit={handleLogin} className={styles['login-form']}>
                        <div className={styles['form-group']}>
                            ...
                            />
                            <div className={styles['form-group-icon']}>
                        ...
                        <div className={styles['form-group']}>
                            ...
                            />
                            <div 
                                className={styles['form-group-icon']}
            ...
            <div className={styles['login-right']}>
                <div className={styles['login-right-content']}>
                    ...
                    <p>Accede al panel administrativo para gestionar el contenido de la asociación. Aquí podrás:</p>
                    <ul className={styles['feature-list']}>
                        <li className={styles['feature-item']}>
                            <span className={styles['feature-icon']}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M10 9L15 12L10 15V9Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                            </span>
                            Publicar actividades y eventos
                        </li>
                        <li className={styles['feature-item']}>
                            <span className={styles['feature-icon']}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className={styles['feature-item']}>
                            ...
                            Administrar usuarios y ubicaciones
                        </li>
                        <li className={styles['feature-item']}>
                            <span className={styles['feature-icon']}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
