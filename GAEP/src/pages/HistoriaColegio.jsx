...
import styles from '../Styles/HistoriaColegio.module.css';

import imgColegio from '../assets/images/img-h1.jpeg';
import img2 from '../assets/images/img-h2.jpg';
import img3 from '../assets/images/img-h3.jpg';
import img4 from '../assets/images/img-h4.jpg';
    ...
    return (
        <>
            ...
            <div className={styles.heroSection}>
                ...
                <div className={styles.historiaOverlay}></div>
            </div>

            <div className={styles.historiaContainer}>
                <div className={styles.historiaGuion}>
                    <Link to="/">Inicio</Link>
                    <span>/</span>
