    ...
    const handleSubmit = async (e) => {
        ...
        if (ubicacion === 'peru') {
            ...
            if (distritoSeleccionado) {
                nuevaUbicacion = { nombre, pais: 'Perú', region, distrito: distritoSeleccionado.nombre, lat: distritoSeleccionado.lat, lng: distritoSeleccionado.lng, promocion };
            }
        } else {
            const paisSeleccionado = paises.find(p => p.nombre === pais);
            if (paisSeleccionado) {
                nuevaUbicacion = { nombre, pais: paisSeleccionado.nombre, lat: paisSeleccionado.lat, lng: paisSeleccionado.lng, promocion };
            }
        }
        if (nuevaUbicacion) {
            try {
